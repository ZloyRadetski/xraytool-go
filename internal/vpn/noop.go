...
func (n *NoopEngine) AddUsersBulk(ctx context.Context, users []domain.VPNUserConfig) error {
	return nil
}
...
func (n *NoopEngine) RebuildInbound(ctx context.Context, tag string) error             { return nil }
