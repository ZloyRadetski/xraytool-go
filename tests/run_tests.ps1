# ==============================================================================
# xraytool Go E2E and Integration Tests Runner
# Runs the new Go E2E test suite and legacy CLI conversion checks
# ==============================================================================
...
Write-Host "`n=== 2. Running Comprehensive Go E2E Tests ===" -ForegroundColor Cyan
go test -v ./tests/...
if ($LASTEXITCODE -ne 0) {
    Write-Host "[FAIL] Some Go E2E tests failed (expected due to known codebase bugs)." -ForegroundColor Yellow
} else {
    Write-Host "[OK] All Go E2E tests passed." -ForegroundColor Green
}

Write-Host "`n=== 3. Testing CLI: JSON to VLESS via Stdin ===" -ForegroundColor Cyan
...
Write-Host "`n=== 3b. Testing CLI: JSON Array to VLESS via Stdin ===" -ForegroundColor Cyan
...
Write-Host "`n=== 4. Testing CLI: VLESS to JSON via Stdin ===" -ForegroundColor Cyan
...
Write-Host " INTEGRATION TESTS RUN COMPLETED!" -ForegroundColor Green
