...
Возвращает расшифрованный файл. Доступ имеет только отправитель файла (если файл еще не привязан к сообщению), либо участники тикета (клиент-владелец и администратор).
